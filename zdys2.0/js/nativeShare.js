...
var nativeShare = function (elementNode, config) {
    ...
    this.html = function() {
        ...
        var html='<ul class="my-info-bot f30 tc bg-white">' +
            '<li data-app="weixin" class="nativeShare weixin"><img src="/img/icon/icon_s01.png"/></li>' +
            '<li data-app="weixinFriend" class="nativeShare weixin_timeline"><img src="/img/icon/icon_s02.png"/></li>' +
            '<li data-app="QQ" class="nativeShare qq"><img src="/img/icon/icon_s03.png"/></li>' +
            '<li data-app="sinaWeibo"  class="nativeShare weibo"><img src="/img/icon/icon_s05.png"/></li>' +
            '</ul>';
